...
public class SistempendaftaranwebinarPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Sistempendaftaranwebinar";
	...
	private SistempendaftaranwebinarPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new SistempendaftaranwebinarPersistentManager();
		}
